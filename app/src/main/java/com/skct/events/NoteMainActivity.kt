...
class NoteMainActivity : AppCompatActivity(), NoteClickInterface, NoteClickDeleteInterface {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        addFAB.setOnClickListener {
            ...
            val intent = Intent(this@NoteMainActivity, AddEditNoteActivity::class.java)
